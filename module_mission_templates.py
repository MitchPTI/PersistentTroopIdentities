...
yell_on_charge = (
  ...
  [
		(store_trigger_param_1, ":issued_order"),
		(store_trigger_param_2, ":issue_agent"),
		
		(eq, ":issued_order", mordr_charge),
		
		(agent_get_team, ":order_team", ":issue_agent"),
		(try_for_agents, ":agent"),
			...
			(assign, ":yell", "snd_man_yell"),
			(try_begin),
				(agent_get_troop_id, ":troop", ":agent"),
				(troop_get_type, ":gender", ":troop"),
				(eq, ":gender", 1),
				
				(assign, ":yell", "snd_woman_yell"),
			(try_end),
			
			(agent_play_sound, ":agent", ":yell"),
		(try_end),
  ])
...
import mod_manager
mission_templates = mod_manager.merge("mission_templates", mission_templates)